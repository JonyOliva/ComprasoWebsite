...
&nbsp;&nbsp;&nbsp;
    ...
    <div class="mt-1 mb-3">
        ...
        <asp:LinkButton ID="lbtnAgregarMenuUsuario" runat="server" OnClick="lbtnAgregarMenuUsuario_Click" ToolTip="Agregar nuevo item." Visible="False">Agregar</asp:LinkButton>
        <br />
        <br />
