...
&nbsp;&nbsp;&nbsp;
    ...
    <div class="mt-1 mb-3">
        ...
        <asp:GridView ID="grdMenuUsuario" horizontalalign="Center" runat="server" AutoGenerateDeleteButton="True" CellPadding="15"  OnRowDeleting="grdMenuUsuario_RowDeleting">
