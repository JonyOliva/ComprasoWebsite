...
&nbsp;&nbsp;&nbsp;
&nbsp;
        <asp:TextBox ID="txtCampo3" runat="server" Visible="False"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblCampo4" runat="server" Visible="False"></asp:Label>
&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtCampo4" runat="server" Visible="False" Width="25px"></asp:TextBox>
        <asp:Label ID="lblSeparadorVenc" runat="server" Text="/" Visible="False"></asp:Label>
        <asp:TextBox ID="txtCampo4b" runat="server" Visible="False" Width="43px"></asp:TextBox>
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;
