...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-center container">
        ...
        <div class="border border-primary">
            ...
            <br />
            <asp:Chart ID="ChVentasAnio" runat="server" EnableViewState="True" Height="600px" Width="1000px" Palette="None" PaletteCustomColors="4, 49, 180">
                <Series>
                ...
                <ChartAreas>
                    <asp:ChartArea Name="ChartArea1">
                        ...
                        <AxisY Title="Total" IntervalType="Number" Interval="10000"></AxisY>
                    </asp:ChartArea>
                </ChartAreas>
            </asp:Chart>
        </div>
